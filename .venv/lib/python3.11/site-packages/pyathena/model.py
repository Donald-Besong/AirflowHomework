...
class AthenaQueryExecution:
    ...
    def __init__(self, response: Dict[str, Any]) -> None:
        ...
        self._execution_parameters: List[str] = query_execution.get(
            "ExecutionParameters", []
        )
        ...
        self._reused_previous_result: Optional[bool] = reuse_info.get(
        ...
        self._expected_bucket_owner: Optional[str] = result_conf.get(
            "ExpectedBucketOwner"
        )
        ...
        self._result_reuse_minutes: Optional[int] = reuse_age_conf.get(
            "MaxAgeInMinutes"
        )
...
class AthenaCalculationExecutionStatus:
    ...
    def __init__(self, response: Dict[str, Any]) -> None:
        ...
        self._dpu_execution_in_millis: Optional[int] = statistics.get(
...
class AthenaSessionStatus:
    ...
    def __init__(self, response: Dict[str, Any]) -> None:
        ...
        self._last_modified_date_time: Optional[datetime] = status.get(

...
class TestSageMakerUIHelper(unittest.TestCase):
    def setUp(self):
        ...
        self.sagemaker_studio.datazone_api.get_paginator.side_effect = (
            self.get_mock_paginator
        )
    ...
    def test_build_remote_execution_config(
        ...
        execution_config.datazone_environment_id = "bogus_environment_id"
        execution_config.datazone_domain_region = "us-east-1"
        execution_config.project_s3_path = "s3://bogus_bucket_name/bogus_domain_id_sm_space/bogus_project_id_sm_space/dev"

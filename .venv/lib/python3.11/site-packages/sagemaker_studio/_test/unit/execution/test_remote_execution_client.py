...
class TestRemoteExecutionClient(unittest.TestCase):
    ...
    @patch.object(
        RemoteExecutionClient, "_RemoteExecutionClient__set_default_tooling_environment"
    )
    @patch.object(
        RemoteExecutionClient, "_RemoteExecutionClient__set_sagemaker_environment"
    )
    ...
    def setUp(
        ...
        self.datazone_api.get_environment_credentials.return_value = (
            self._default_env_creds()
        )
    ...
    def test_validate_input_config(self):
        ...
        self.assertEqual(
            str(ve.exception), "InputConfig is required for remote execution"
        )
            ...
            "Results": [
                {
                    "TrainingJob": {
                        ...
                        "TrainingStartTime": datetime(
                            2024, 8, 8, 10, 0, 0, tzinfo=timezone.utc
                        ),
                        "TrainingEndTime": datetime(
                            2024, 8, 8, 11, 0, 0, tzinfo=timezone.utc
                        ),
                        "Tags": [
                ...
                },
                {
                    "TrainingJob": {
                        ...
                        "TrainingJobStatus": "Completed",
                        "TrainingStartTime": datetime(
                            2024, 8, 9, 10, 0, 0, tzinfo=timezone.utc
                        ),
                        "TrainingEndTime": datetime(
                            2024, 8, 9, 11, 0, 0, tzinfo=timezone.utc
                        ),
                        "Tags": [
                            {"Key": "sagemaker-notebook-execution", "Value": "TRUE"},
                            {"Key": "sagemaker-notebook-name", "Value": "test.ipynb"},
    ...
    def test_start_execution_happy_path(self, mock_uuid):
        ...
        self.remote_client.sagemaker_client = mock_sagemaker_client
        self.remote_client.kms_key_identifier = "arn:aws:kms:us-west-2:123456123456:key/1234abcd-12ab-34cd-56ef-1234567890ab"
        self.remote_client.user_role_arn = (
            "arn:aws:iam::123456123456:role/SageMakerRole"
        )
        ...
        self.remote_client._utils._get_project_s3_path.return_value = (
        ...
        input = {
            "path": "s3://my-bucket/my-project/workflows/project-files",
            "file": "test.ipynb",
        }
        output = {
            "path": "s3://my-bucket/my-project/workflows/output",
            "file": "_test.ipynb",
        }
        ...
        self.assertEqual(
            call_args["ResourceConfig"]["VolumeKmsKeyId"],
            self.remote_client.kms_key_identifier,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            call_args["Environment"]["SM_INPUT_NOTEBOOK_NAME"], input["file"]
        )
        self.assertEqual(
            call_args["Environment"]["SM_OUTPUT_NOTEBOOK_NAME"], output["file"]
        )
        self.assertEqual(
            call_args["VpcConfig"]["SecurityGroupIds"],
            [self.remote_client.security_group],
        )
    ...
    def test_start_execution_with_minimum_input_fields_provided(self, mock_uuid):
        ...
        self.assertEqual(
            call_args["AlgorithmSpecification"]["TrainingImage"], default_ecr_uri
        )
        self.assertEqual(call_args["RoleArn"], self.remote_client.user_role_arn)
        self.assertEqual(call_args["OutputDataConfig"]["S3OutputPath"], output["path"])
        self.assertEqual(
        ...
        self.assertEqual(
            call_args["ResourceConfig"]["InstanceType"], DEFAULT_INSTANCE_TYPE
        )

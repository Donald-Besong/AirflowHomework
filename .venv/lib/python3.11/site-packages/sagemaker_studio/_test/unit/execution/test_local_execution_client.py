...
class TestLocalExecutionClient(unittest.TestCase):
    ...
    class MockLocalExecutionUtils:
        ...
        def mock_fetch_data(url: str, params: dict = {}) -> dict:
            ...
            if (
                url
                == f"{LocalExecutionUtils.LOCAL_JOBS_SCHEDULER_URL}/bogus_execution_id"
                and not params
            ):  # get_execution
    ...
    def test_start_execution(
        ...
        mock_fetch_data_func.side_effect = self.MockLocalExecutionUtils.mock_fetch_data
        mock_get_bytes_free_func.side_effect = (
            self.MockLocalExecutionUtils.mock_get_bytes_free
        )
        mock_get_bytes_needed_func.side_effect = (
            self.MockLocalExecutionUtils.mock_get_bytes_needed
        )

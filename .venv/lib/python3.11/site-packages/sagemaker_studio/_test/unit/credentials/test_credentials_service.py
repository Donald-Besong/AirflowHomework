...
class TestCredentialsVendingService(unittest.TestCase):
    ...
    def test_get_domain_execution_role_credential_in_space_validation_exception(self):
        ...
        with self.assertRaises(ValueError) as context:
            self.credentials_service.get_domain_execution_role_credential_in_space(
                "invalid-domain"
            )
        self.assertEqual(
    ...
    def test_get_domain_execution_role_credentials_in_space_access_denied_exception(
        self,
    ):
        error_response = {
            "Error": {
    ...
    def test_get_project_default_environment_credentials(self):
        ...
        def mock_get_project_default_environment(domain_identifier, project_identifier):
            if (
                domain_identifier == "domain_123"
                and project_identifier == "project_123"
            ):
                return {
        ...
        def mock_get_environment_credentials(*args, **kwargs):
            ...
            if (
                domain_identifier == "domain_123"
                and environment_identifier == "environment_123"
            ):
    ...
    def test_get_project_default_environment_credentials_raises_other_exception(self):
        ...
        with self.assertRaises(ValueError) as context:
            ...
            self.assertTrue(
                "Unable to get default environment credentials"
                in str(context.exception)
            )

    def test_get_project_default_environment_credentials_raises_validation_exception(
        self,
    ):
        error_response = {
            "Error": {

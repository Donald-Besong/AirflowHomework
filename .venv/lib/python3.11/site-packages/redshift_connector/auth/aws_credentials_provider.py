...
class AWSCredentialsProvider:
    ...
    def __init__(self: "AWSCredentialsProvider") -> None:
        self.cache: typing.Dict[
            int, typing.Union[AWSDirectCredentialsHolder, AWSProfileCredentialsHolder]
        ] = {}
    ...
    def get_credentials(
        ...
        credentials: typing.Union[
            AWSDirectCredentialsHolder, AWSProfileCredentialsHolder
        ] = self.cache[key]
    ...
    def refresh(self: "AWSCredentialsProvider") -> None:
        ...
        credentials: typing.Optional[
            typing.Union[AWSProfileCredentialsHolder, AWSDirectCredentialsHolder]
        ] = None

        if self.profile is not None:
            credentials = AWSProfileCredentialsHolder(

...
class BrowserAzureOAuth2CredentialsProvider(JwtCredentialsProvider):
    ...
    def get_cache_key(self: "BrowserAzureOAuth2CredentialsProvider") -> str:
        return "{}{}".format(
            self.idp_tenant if self.idp_tenant else "",
            self.client_id if self.client_id else "",
        )
        ...
        with conn:
            while True:
                ...
                state_idx: int = decoded_part.find(
                    "{}=".format(
                        BrowserAzureOAuth2CredentialsProvider.OAuthParamNames.STATE.value
                    )
                )
                ...
                if state_idx > -1:
                    ...
                    code_idx: int = decoded_part.find(
                        "{}=".format(
                            BrowserAzureOAuth2CredentialsProvider.OAuthParamNames.IDP_CODE.value
                        )
                    )
    ...
    def get_authorization_token_url(self, state: str) -> str:
        ...
        """
        _logger.debug(
            "BrowserAzureOAuth2CredentialsProvider.get_authorization_token_url"
        )
        ...
        params: typing.Dict[str, str] = {
            ...
            BrowserAzureOAuth2CredentialsProvider.OAuthParamNames.CLIENT_ID.value: typing.cast(
                str, self.client_id
            ),
            ...
            BrowserAzureOAuth2CredentialsProvider.OAuthParamNames.SCOPE.value: "openid {}".format(
                self.scope
            ),
        }
        ...
        try:
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                future = executor.submit(
                    self.run_server, listen_socket, self.idp_response_timeout, state
                )
    ...
    def fetch_jwt_response(
        self: "BrowserAzureOAuth2CredentialsProvider", token: str
    ) -> str:
        """
        ...
        params: typing.Dict[str, str] = {
            ...
            BrowserAzureOAuth2CredentialsProvider.OAuthParamNames.SCOPE.value: typing.cast(
                str, self.scope
            ),
            BrowserAzureOAuth2CredentialsProvider.OAuthParamNames.CLIENT_ID.value: typing.cast(
                str, self.client_id
    ...
    def extract_jwt_assertion(
        self: "BrowserAzureOAuth2CredentialsProvider", content: str
    ) -> str:
        """

...
class IPlugin(ABC):
    ...
    def get_credentials(
        self: "IPlugin",
    ) -> typing.Union["NativeTokenHolder", "CredentialsHolder"]:
        """
    ...
    def handle_missing_required_property(property_name: str) -> None:
        ...
        error_msg: str = "Missing required connection property: {}".format(
            property_name
        )
    ...
    def handle_invalid_property_value(property_name: str, reason: str) -> None:
        ...
        error_msg: str = (
            "Invalid value specified for connection property: {}. {}".format(

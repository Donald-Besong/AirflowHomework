...
class BrowserSamlCredentialsProvider(SamlCredentialsProvider):
    ...
    def add_parameter(
        self: "BrowserSamlCredentialsProvider", info: RedshiftProperty
    ) -> None:
        ...
        try:
            with concurrent.futures.ThreadPoolExecutor() as executor:
                ...
                future = executor.submit(
                    self.run_server, self.listen_port, self.idp_response_timeout
                )
                self.open_browser()
    ...
    def run_server(
        self: "BrowserSamlCredentialsProvider",
        listen_port: int,
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            ...
            _logger.debug(
                "Localhost socket connection established for Browser SAML IdP"
            )
            ...
            with conn:
                while True:
                    ...
                    _logger.debug(
                        "Data received contained SAML Response: %s", result is not None
                    )

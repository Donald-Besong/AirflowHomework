...
class MetadataAPIPostProcessing(MetadataAPIHelper):
    ...
    def get_catalog_post_processing(
        self, intermediate_rs: typing.Tuple
    ) -> typing.Tuple:
        ...
        if self._cursor._SHOW_DATABASES_Col_index is not None:
            for row in intermediate_rs:
                final_row: typing.List = [
                    row[
                        self._cursor._SHOW_DATABASES_Col_index[
                            self._SHOW_DATABASES_database_name
                        ]
                    ]
                ]
    ...
    def get_schema_post_processing(
        self, intermediate_rs: typing.List[typing.Tuple]
    ) -> typing.Tuple:
        ...
        if self._cursor._SHOW_SCHEMAS_Col_index is not None:
            for rs in intermediate_rs:
                for row in rs:
                    final_row: typing.List = [
                        row[
                            self._cursor._SHOW_SCHEMAS_Col_index[
                                self._SHOW_SCHEMA_schema_name
                            ]
                        ],
                        row[
                            self._cursor._SHOW_SCHEMAS_Col_index[
                                self._SHOW_SCHEMA_database_name
                            ]
                        ],
                    ]
    ...
    def get_table_post_processing(
        self, intermediate_rs: typing.List[typing.Tuple], types: list
    ) -> typing.Tuple:
            ...
            for rs in intermediate_rs:
                for row in rs:
                    if (
                        ...
                        or len(types) == 0
                        or row[
                            self._cursor._SHOW_TABLES_Col_index[
                                self._SHOW_TABLES_table_type
                            ]
                        ]
                        in types
                    ):
                        final_row: typing.List = [
                            row[
                                self._cursor._SHOW_TABLES_Col_index[
                                    self._SHOW_TABLES_database_name
                                ]
                            ],
                            row[
                                self._cursor._SHOW_TABLES_Col_index[
                                    self._SHOW_TABLES_schema_name
                                ]
                            ],
                            row[
                                self._cursor._SHOW_TABLES_Col_index[
                                    self._SHOW_TABLES_table_name
                                ]
                            ],
                            row[
                                self._cursor._SHOW_TABLES_Col_index[
                        ...
                        if len(final_row) != self._TablesColNum:
                            raise InterfaceError(
                                "Tuple row has incorrect column number"
                            )

                        final_rs += (final_row,)
        return final_rs

    def get_column_post_processing(
        self, intermediate_rs: typing.List[typing.Tuple]
    ) -> typing.Tuple:
        ...
        if self._cursor._SHOW_COLUMNS_Col_index is not None:
            for rs in intermediate_rs:
                for row in rs:
                    data_type: str = row[
                        self._cursor._SHOW_COLUMNS_Col_index[
                            self._SHOW_COLUMNS_data_type
                        ]
                    ]
                    ...
                    rs_type, date_time_customize_precision, precisions = (
                        self.get_second_fraction(data_type)
                    )
                    ...
                    final_row: typing.List = [
                        row[
                            self._cursor._SHOW_COLUMNS_Col_index[
                                self._SHOW_COLUMNS_database_name
                            ]
                        ],
                        row[
                            self._cursor._SHOW_COLUMNS_Col_index[
                                self._SHOW_COLUMNS_schema_name
                            ]
                        ],
                        row[
                            self._cursor._SHOW_COLUMNS_Col_index[
                                self._SHOW_COLUMNS_table_name
                            ]
                        ],
                        row[
                            self._cursor._SHOW_COLUMNS_Col_index[
                                self._SHOW_COLUMNS_column_name
                            ]
                        ],
                        sql_type,
                        rs_type,
                        self.get_column_size(
                            ...
                            row[
                                self._cursor._SHOW_COLUMNS_Col_index[
                                    self._SHOW_COLUMNS_numeric_precision
                                ]
                            ],
                            row[
                                self._cursor._SHOW_COLUMNS_Col_index[
                                    self._SHOW_COLUMNS_character_maximum_length
                                ]
                            ],
                        ),
                        None,
                        self.get_decimal_digits(
                            ...
                            row[
                                self._cursor._SHOW_COLUMNS_Col_index[
                                    self._SHOW_COLUMNS_numeric_scale
                                ]
                            ],
                            precisions,
                        ...
                        self.get_nullable(
                            row[
                                self._cursor._SHOW_COLUMNS_Col_index[
                                    self._SHOW_COLUMNS_is_nullable
                                ]
                            ]
                        ),
                        row[
                            self._cursor._SHOW_COLUMNS_Col_index[
                                self._SHOW_COLUMNS_remarks
                            ]
                        ],
                        row[
                            self._cursor._SHOW_COLUMNS_Col_index[
                                self._SHOW_COLUMNS_column_default
                            ]
                        ],
                        sql_type,
                        None,
                        ...
                        row[
                            self._cursor._SHOW_COLUMNS_Col_index[
                                self._SHOW_COLUMNS_ordinal_position
                            ]
                        ],
                        row[
                            self._cursor._SHOW_COLUMNS_Col_index[

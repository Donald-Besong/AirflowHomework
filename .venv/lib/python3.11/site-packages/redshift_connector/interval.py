...
class Interval:
    ...
    def __init__(
        self: "Interval", microseconds: int = 0, days: int = 0, months: int = 0
    ) -> None:
...
class IntervalYearToMonth(Interval):
    ...
    def __init__(
        ...
        months: int = 0,
        year_month: typing.Optional[typing.Tuple[int, int]] = None,
    ) -> None:
    ...
    def _setMicroseconds(self: "IntervalYearToMonth", value: int) -> None:
        raise ValueError(
            "microseconds cannot be set for an Interval Year To Month object"
        )
...
class IntervalDayToSecond(Interval):
    ...
    def __init__(
        ...
        microseconds: int = 0,
        timedelta: typing.Optional[Timedelta] = None,
    ) -> None:

...
class CredentialsHolder(ABCCredentialsHolder):
    ...
    class IamMetadata:
        ...
        def set_auto_create(
            ...
            _logger.debug(
                "CredentialsHolder.IamMetadata.set_auto_create %s", auto_create
            )
        ...
        def set_saml_db_user(
            ...
            _logger.debug(
                "CredentialsHolder.IamMetadata.set_saml_db_user %s", saml_db_user
            )
        ...
        def set_profile_db_user(
            ...
            _logger.debug(
                "CredentialsHolder.IamMetadata.set_profile_db_user %s", profile_db_user
            )
        ...
        def set_allow_db_user_override(
            ...
            _logger.debug(
                "CredentialsHolder.IamMetadata.set_allow_db_user_override %s",

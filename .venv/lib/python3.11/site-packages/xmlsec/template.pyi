...
def create(
    node: _Element, c14n_method: Transform, sign_method: Transform
) -> _Element: ...
...
def encrypted_data_ensure_key_info(
    node: _Element, id: str | None = ..., ns: str | None = ...
) -> _Element: ...
def ensure_key_info(node: _Element, id: str | None = ...) -> _Element: ...
def transform_add_c14n_inclusive_namespaces(
    node: _Element, prefixes: str | Sequence[str]
) -> None: ...
...
def x509_issuer_serial_add_issuer_name(
    node: _Element, name: str | None = ...
) -> _Element: ...
def x509_issuer_serial_add_serial_number(
    node: _Element, serial: str | None = ...
) -> _Element: ...

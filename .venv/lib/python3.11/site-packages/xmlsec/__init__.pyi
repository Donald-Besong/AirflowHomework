...
class Key:
    ...
    def from_binary_file(
        cls: type[Self], klass: KeyData, filename: StrOrBytesPath
    ) -> Self: ...
    @classmethod
    def from_file(
        cls: type[Self],
        file: GenericPath[AnyStr] | IO[AnyStr],
        format: int,
        password: str | None = ...,
    ) -> Self: ...
    @classmethod
    ...
    @classmethod
    def from_memory(
        cls: type[Self], data: AnyStr, format: int, password: str | None = ...
    ) -> Self: ...
    @classmethod
    def generate(cls: type[Self], klass: KeyData, size: int, type: int) -> Self: ...
    def load_cert_from_file(
        self, file: GenericPath[AnyStr] | IO[AnyStr], format: int
    ) -> None: ...
...
class SignatureContext:
    ...
    def register_id(
        self, node: _Element, id_attr: str = ..., id_ns: str | None = ...
    ) -> None: ...
    ...
    def verify_binary(
        self, bytes: bytes, transform: Transform, signature: bytes
    ) -> None: ...

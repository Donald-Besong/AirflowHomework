...
class DynamoDBToS3Operator(AwsToAwsBaseOperator):
    ...
    def _export_entire_data(self):
        ...
        scan_kwargs = (
            copy(self.dynamodb_scan_kwargs) if self.dynamodb_scan_kwargs else {}
        )
        err = None
        f: IO[Any]
    ...
    def _scan_dynamodb_and_upload_to_s3(
        self, temp_file: IO, scan_kwargs: dict, table: Any
    ) -> IO:
        while True:

...
class ComprehendStartPiiEntitiesDetectionJobOperator(ComprehendBaseOperator):
    ...
    def execute(self, context: Context) -> str:
        ...
        job_url = ComprehendPiiEntitiesDetectionLink.format_str.format(
            aws_domain=ComprehendPiiEntitiesDetectionLink.get_aws_domain(
    ...
    def execute_complete(
        ...
        self.log.info(
            "Comprehend pii entities detection job `%s` complete.",
...
class ComprehendCreateDocumentClassifierOperator(AwsBaseOperator[ComprehendHook]):
    ...
    def execute(self, context: Context) -> str:
        if self.output_data_config:
            self.document_classifier_kwargs["OutputDataConfig"] = (
        ...
        job_url = ComprehendDocumentClassifierLink.format_str.format(
            aws_domain=ComprehendDocumentClassifierLink.get_aws_domain(
                self.hook.conn_partition
            ),
            region_name=self.hook.conn_region_name,
    ...
    def execute_complete(
        ...
        if validated_event["status"] != "success":
            raise AirflowException(
                "Error while running comprehend create document classifier: %s",
                validated_event,
            )
        ...
        self.log.info(
            ...
            validated_event["document_classifier_arn"],
        )

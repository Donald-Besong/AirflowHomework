...
class BedrockKnowledgeBaseActiveSensor(BedrockBaseSensor[BedrockAgentHook]):
    ...
    def get_state(self) -> str:
        return self.hook.conn.get_knowledge_base(
...
class BedrockBatchInferenceSensor(BedrockBaseSensor[BedrockHook]):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        base_intermediate_states: tuple[str, ...] = (
            "Submitted",
            "InProgress",
            "Stopping",
            "Validating",
        ...
        BedrockBatchInferenceSensor.INTERMEDIATE_STATES = (
            intermediate_states or base_intermediate_states
        )
        BedrockBatchInferenceSensor.SUCCESS_STATES = (
            success_states or base_success_states
        )

    def get_state(self) -> str:
        return self.hook.conn.get_model_invocation_job(jobIdentifier=self.job_arn)[
            "status"
        ]

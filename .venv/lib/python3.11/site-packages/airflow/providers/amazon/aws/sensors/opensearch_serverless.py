...
class OpenSearchServerlessCollectionActiveSensor(
    AwsBaseSensor[OpenSearchServerlessHook]
):
    """
    ...
    def poke(self, context: Context, **kwargs) -> bool:
        ...
        state = self.hook.conn.batch_get_collection(**call_args)["collectionDetails"][
            0
        ]["status"]

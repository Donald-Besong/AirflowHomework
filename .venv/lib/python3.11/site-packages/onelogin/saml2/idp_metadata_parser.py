...
class OneLogin_Saml2_IdPMetadataParser(object):
    ...
    def parse_remote(
        ...
        :rtype: dict
        """
        idp_metadata = cls.get_metadata(
            url, validate_cert, timeout, headers=kwargs.pop("headers", None)
        )
    ...
    def parse(
        ...
        idp_entity_id = want_authn_requests_signed = idp_name_id_format = (
            idp_sso_url
        ) = idp_slo_url = certs = None
        ...
        if len(entity_descriptor_nodes) > 0:
            ...
            if len(idp_descriptor_nodes) > 0:
                ...
                want_authn_requests_signed = idp_descriptor_node.get(
                ...
                if want_authn_requests_signed is not None:
                    data["security"] = {}
                    data["security"]["authnRequestsSigned"] = (

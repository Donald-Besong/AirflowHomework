...
class OneLogin_Saml2_Settings(object):
    ...
    def _add_default_values(self):
        ...
        self._sp["singleLogoutService"].setdefault(
    ...
    def get_sp_metadata(self):
        ...
        add_encryption = (
            self._security["wantNameIdEncrypted"]
            or self._security["wantAssertionsEncrypted"]
        )
        ...
        # Sign metadata
        if (
            "signMetadata" in self._security
            and self._security["signMetadata"] is not False
        ):
    ...
    def validate_metadata(self, xml):
        ...
        root = OneLogin_Saml2_XML.validate_xml(
            xml, "saml-schema-metadata-2.0.xsd", self._debug
        )
    ...
    def format_sp_cert_new(self):
        ...
        Formats the SP cert.
        """
        self._sp["x509certNew"] = OneLogin_Saml2_Utils.format_cert(
            self._sp["x509certNew"]
        )
    ...
    def format_sp_key(self):
        ...
        """
        self._sp["privateKey"] = OneLogin_Saml2_Utils.format_private_key(
            self._sp["privateKey"]
        )
